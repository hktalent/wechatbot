...
*/
func Query4Key(szIndex string, szQuery string) interface{} {
...
func Query4KeyFrom(szIndex string, szQuery string, from, size uint64) *bleve.SearchResult {
	...
	if nil == json.Unmarshal([]byte(`{"size":10,"from":0,"explain":false,"highlight":{},"query":{"boost":1,"query":"\"poc\""},"fields":["*"]}`), &m1) {
